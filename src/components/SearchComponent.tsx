      ...
      <div id="poda" className="relative flex items-center justify-center group">
        ...
        <div className="relative group">
          <input
            ...
            className="bg-[#010201] border-none w-[301px] h-[56px] rounded-lg text-white px-[59px] pr-14 text-lg focus:outline-none placeholder-gray-400"
            aria-label="배수구 코드로 검색"
          />
          <div className="pointer-events-none w-[100px] h-[20px] absolute bg-gradient-to-r from-transparent to-black top-[18px] left-[70px] group-focus-within:hidden" aria-hidden />
          <div className="pointer-events-none w-[30px] h-[20px] absolute bg-[#cf30aa] top-[10px] left-[5px] blur-2xl opacity-80 transition-all duration-2000 group-hover:opacity-0" aria-hidden />
          <button
            type="button"
            onClick={onSubmit}
            className="absolute h-[42px] w-[40px] overflow-hidden top-[7px] right-[7px] rounded-lg cursor-pointer
                          ...
                          before:brightness-135 before:animate-spin-slow focus:outline-none focus:ring-2 focus:ring-white/30"
            title="이동"
            aria-label="검색 이동"
          />
          <div className="absolute left-5 top-[15px] pointer-events-none" aria-hidden>
